...
at all stations and put the associated adjoint sources under 
the SEM directory as we discussed at the class. Be careful with 
the naming convention of adjoint sources and make sure that 
all synthetics and adjoint sources have the same starting time, 
length and sampling rate.

Ideally, you can compute event kernels for different misfit functions 
to compare the effect of measurements. But a misfit function of your 
