...
The purpose of this assignment is to create an event kernel.

# Prompt

Please extend your assignment 3 to compute an event kernel. 
All you need to do is to add more stations and make measurements 
at all stations and put the associated adjoint sources under the 
SEM directory as we discussed at the class. Be careful with the naming 
convention of adjoint sources and make sure that all synthetics and adjoint 
sources have the same starting time, length and sampling rate.

Ideally, you can compute event kernels for different misfit functions to 
compare the effect of measurements. But a misfit function of your choice 
would be enough.

:::{.note}
Although the prompt says to extend assignment 3, I inferred assignment 4
was probably the intention as assignment 3 didn't have a specific model
prescribed.
:::
...
The misfit functions used are described in the next sections.
